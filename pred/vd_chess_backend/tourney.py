...
def stringToEngine(s):
    ...
    elif dat['engine'] == 'vivan':
        return vivanEngine(**dat['config'])
    elif dat['engine'] == 'vivan_old':
        return OldvivanEngine(**dat['config'])
    elif dat['engine'] == 'vivan_new':
        return NewvivanEngine(**dat['config'])
